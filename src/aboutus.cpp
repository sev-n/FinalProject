...
void about_us(){
	...
	cout<< dye::bright_white("\t    programmers will provide directly to him. The members also have the option not to give their")<<endl;
	cout<< dye::bright_white("\t    information if they want to.\n\n") << endl;

	cout<< "\t\t\t\t\t\t" << dye::black_on_white(" DATA PRIVACY AGREEMENT ") << "\n\n" <<endl;
	cout<< dye::bright_white("\t\tWe, the members, have read Data Privacy Statement and express my consent for the main programmer")<<endl;
	cout<< dye::yellow("\t   'Nerwin Panis'") << dye::bright_white(" to collect, record, organize, update, or modify, retrieve, consult, use, block, erase, ")<<endl;
	cout<< dye::bright_white("\t   consolidate, destruct my personal data as part of my information.\n")<<endl;
	
	cout<< dye::bright_white("\t\tWe hereby, affirm our right to be informed, object to process, access and rectify, suspend or")<<endl;
	cout<< dye::bright_white("\t   withdraw my personal data, and be indemnified in case of damages pursuant to the provisions of the")<<endl;
	cout<< dye::yellow("\t   Republic Act No. 10173") << dye::bright_white(" of the Philippines, Data Privacy of 2012 and its corresponding Implementing")<<endl;
	cout<< dye::bright_white("\t   Rules and Regulations.\n\n") <<endl;
