...
void about_us(){
    ...
    cout<<"\t\t\t\t\t\t  OBJECTIVES\n\n\n";
    cout<<"\t\tThis programming project objective is to provide the student with the opportunity to"<<endl;
    cout<<"\t   work on a computer program to solve a simple related problem. This program contains the C++"<<endl;
    ...
    cout<<"\t\t    HBBS: Cycling & Play Online Games\t\t\t            HBBS: Online Games & Making\
	\t\t\t\t\t\t\t\t\t\t\t\t          Tiktok Videos"<<endl;
    cout<<"\t\t    ADRS: Paliparan III Cavite\t\t\t\t\t    ADRS: GMA Cavite\n\n"<<endl;
    cout<<"\t\t[5] NAME: Melvin Vardeleon\t\t\t\t\t[6] NAME: Cedrick John Guevarra"<<endl;
    cout<<"\t\t    AGE : 18\t\t\t\t\t\t\t    AGE : 19"<<endl;
    cout<<"\t\t    GNDR: Male\t\t\t\t\t\t\t    GNDR: Male"<<endl;
    cout<<"\t\t    HBBS: Online Games, Motorcycle\t\t\t\t    HBBS: Music & Play Online Games"<<endl;
    cout<<"\t\t    ADRS: Paliparan I Cavite\t\t\t\t\t    ADRS: Sta.Rosa Laguna\n\n"<<endl;
	...
	cout<<"\t\tOne of The Main Programmer (Nerwin Panis), collects a variety of information that the other programmers"<<endl; 
	cout<<"\t   will provide directly to him. The members also have the option not to give their information if they want to.\n\n"<<endl;
